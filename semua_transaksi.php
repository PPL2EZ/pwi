...
<?php
	...
	echo'<tr><td colspan="9" align="center" ><h2> Semua Transaksi Pending </h2></td></tr>';
	echo '<table border ="1">';
				echo'<tr >';
					...
					echo'<th width="270px"class = "tengah" >Action</th>';
				echo'</tr>';
					...
					//Asign a query
					$query = " SELECT penjualan.tgl_penjualan, penjualan.id_pelanggan, detail_penjualan.quantity, penjualan.total_harga,penjualan.id_penjualan
